...
# 在文件开头定义完 MIN_MAX_CONSTANTS、PREPROCESS_FN、NORM_FN、DENORM_FN 之后

# 让 sst 等同于 tas
MIN_MAX_CONSTANTS["sst"] = MIN_MAX_CONSTANTS["tas"]

# sst 本身就是 °C，不需要从 K 转
PREPROCESS_FN["sst"] = lambda x: x

# 归一化与 tas 一致
NORM_FN["sst"]   = NORM_FN["tas"]
DENORM_FN["sst"] = DENORM_FN["tas"]
